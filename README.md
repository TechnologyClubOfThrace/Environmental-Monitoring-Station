...
|  Αισθητήρας | Μοντέλο | Datasheet | Κατανάλωση | Arduino API | Κόστος | Αγορά από  |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
